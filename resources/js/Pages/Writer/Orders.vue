                            ...
                            <table class="w-full whitespace-no-wrap">
                                ...
                                >
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <button class="flex items-center justify-center p-4 bg-gray-800 hover:bg-gray-900 transition duration-300 rounded-lg text-sm shadow-xs font-semibold text-green-200" disabled>
                                                Add new File
                                            </button>
                                        </td>
                                    </tr>
